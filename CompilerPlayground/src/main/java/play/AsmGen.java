...
public class AsmGen extends PlayScriptBaseVisitor<String> {
    ...
    private final String[] registersl = {"%eax", "%ebx", "%r10d", "%r11d", "%r12d", "%r13d", "%r14d", "%r15d"};
    private final String[] paramRegisterl = {"%edi", "%esi", "%edx", "%ecx", "%r8d", "%r9d"};
    private final String[] paramRegisterq = {"%rdi", "%rsi", "%rdx", "%rcx", "%r8", "%r9"};
