// Generated from H:/Workspace/antlr-tutorial/src/main/antlr4\Math.g4 by ANTLR 4.10.1
...
public class MathParser extends Parser {
	...
	public static class SingleStatementContext extends StatContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public SingleStatementContext(StatContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MathListener ) ((MathListener)listener).enterSingleStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MathListener ) ((MathListener)listener).exitSingleStatement(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MathVisitor ) return ((MathVisitor<? extends T>)visitor).visitSingleStatement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MulDivContext extends ExprContext {
		...
		public TerminalNode MUL() { return getToken(MathParser.MUL, 0); }
	...
	public static class AddSubContext extends ExprContext {
		...
		public TerminalNode ADD() { return getToken(MathParser.ADD, 0); }
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(33);
						((MulDivContext)_localctx).oper = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==MUL || _la==DIV) ) {
							((MulDivContext)_localctx).oper = (Token)_errHandler.recoverInline(this);
						}
						else {
					...
					case 2:
						...
						setState(36);
						((AddSubContext)_localctx).oper = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==ADD || _la==SUB) ) {
							((AddSubContext)_localctx).oper = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
